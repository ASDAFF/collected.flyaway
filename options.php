...
$aTabs = array();
$aTabs[] = array('DIV' => 'collected_flyaway', 'TAB' => GetMessage('RS.FLYAWAY.TAB_NAME_SETTINGS'), 'ICON' => '', 'TITLE' => GetMessage('RS.FLYAWAY.TAB_TITLE_SETTINGS'));
if(!empty($_REQUEST['dev'])) {
	$aTabs[] = array('DIV' => 'collected_flyaway_dev', 'TAB' => GetMessage('RS.FLYAWAY.TAB_NAME_DEV'), 'ICON' => '', 'TITLE' => GetMessage('RS.FLYAWAY.TAB_TITLE_DEV'));
}
...
?></tr><?
$openMenuType = COption::GetOptionString('collected.flyaway', 'openMenuType', 'type1');
?><tr><?
...
?></tr><?
$presets = COption::GetOptionString('collected.flyaway', 'presets', 'preset_1');
?><tr><?
...
?></tr><?
$bannerType = COption::GetOptionString('collected.flyaway', 'bannerType', 'type1');
?><tr><?
...
?></tr><?
$filterSide = COption::GetOptionString('collected.flyaway', 'filterSide', 'left');
?><tr><?
...
?></tr><?
/*$blackMode = COption::GetOptionString('collected.flyaway', 'blackMode', 'N');
?><tr><?
...
?></tr><?
$Fichi = COption::GetOptionString('collected.flyaway', 'Fichi', 'Y');
?><tr><?
...
?></tr><?
$SmallBanners = COption::GetOptionString('collected.flyaway', 'SmallBanners', 'Y');
?><tr><?
...
?></tr><?
$New = COption::GetOptionString('collected.flyaway', 'New', 'Y');
?><tr><?
...
?></tr><?
$PopularItem = COption::GetOptionString('collected.flyaway', 'PopularItem', 'Y');
?><tr><?
...
?></tr><?
$Service = COption::GetOptionString('collected.flyaway', 'Service', 'Y');
?><tr><?
...
?></tr><?
$AboutAndReviews = COption::GetOptionString('collected.flyaway', 'AboutAndReviews', 'Y');
?><tr><?
...
?></tr><?
$News = COption::GetOptionString('collected.flyaway', 'News', 'Y');
?><tr><?
...
?></tr><?
$Partners = COption::GetOptionString('collected.flyaway', 'Partners', 'Y');
?><tr><?
...
?></tr><?
$Gallery = COption::GetOptionString('collected.flyaway', 'Gallery', 'Y');
?><tr><?
