...
if (!empty($arResult)) {
    if (is_array($arResult['OFFERS']) && count($arResult['OFFERS']) > 0) {
        ...
        $arResult['OFFERS_EXT'] = RSDevLibOffersExtension::GetSortedProperties($arResult['OFFERS'], $arParams['OFFER_TREE_PROPS']);
        // /Get sorted properties
    }
...
/* JSON OFFERS */
$arResult['JSON_EXT'] = RSDevLibOffersExtension::GetJSONElement(
    $arResult,
