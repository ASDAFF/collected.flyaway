         ...
         <?php if (!empty($arElements) && is_array($arElements)): ?>
               ...
               <div class="col col-md-12">
                 ...
                 $APPLICATION->IncludeComponent(
                     ...
                     array(
                             ...
                             "COLLECT_CNT_TEMPLATES" => "4",
                             "COLLECT_DEFAULT_TEMPLATE" => $arParams['RSFLYAWAY_SORTER_TEMPLATE_DEFAULT'],
                             "COLLECT_SORT_BY_NAME" => array("name", "PROPERTY_PRICE"),
                             "COLLECT_SORT_BY_DEFAULT" => "PROPERTY_PRICE_asc",
                             "COLLECT_OUTPUT_OF" => array("5", "10", "15", "20", ""),
                             "COLLECT_OUTPUT_OF_DEFAULT" => "15",
                             "COLLECT_OUTPUT_OF_SHOW_ALL" => "N",
                             "COLLECT_CNT_TEMPLATES_0" => "",
                             "COLLECT_CNT_TEMPLATES_NAME_0" => "list_little",
                             "COLLECT_CNT_TEMPLATES_1" => "",
                             "COLLECT_CNT_TEMPLATES_NAME_1" => "list",
                             "COLLECT_CNT_TEMPLATES_2" => "",
                             "COLLECT_CNT_TEMPLATES_NAME_2" => "showcase",
                             "COLLECT_CNT_TEMPLATES_3" => "",
                             "COLLECT_CNT_TEMPLATES_NAME_3" => "showcase_mob",
             ...
             <div class="col col-md-12">
                 ...
                 array(
                    'IBLOCK_TYPE' => $arParams['IBLOCK_TYPE'],
                    'IBLOCK_ID' => $arParams['IBLOCK_ID'],
                    "ELEMENT_SORT_FIELD" => ( $urlseSorter ? $collectCSortType : $arParams["ELEMENT_SORT_FIELD"] ),
