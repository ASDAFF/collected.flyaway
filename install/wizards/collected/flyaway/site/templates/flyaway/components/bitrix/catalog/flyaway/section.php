...
if ($arParams['RSFLYAWAY_SHOW_SORTER'] == 'Y' && \Bitrix\Main\Loader::includeModule("collected.developkit")) {
  $useSorter = true;
}
        ...
        <div class="catalog-content">
            <div class="row">
                ...
                <?php if($useSorter): ?>
                    <div class="col col-md-12">
                        ...
                        foreach ($sorterTemplates as $index => $templateName) {
                          	$sorterTemplatesParameters["COLLECT_CNT_TEMPLATES_".$index] = "";
                          	$sorterTemplatesParameters["COLLECT_CNT_TEMPLATES_NAME_".$index] = $templateName;
                        }
                        ...
                        $APPLICATION->IncludeComponent(
                            ...
                            array_merge(
                                array(
                                    ...
                                    "COLLECT_CHOSE_TEMPLATES_SHOW" => $arParams['RSFLYAWAY_SORTER_SHOW_TEMPLATE'],
                                    "COLLECT_SORT_BY_SHOW" => $arParams['RSFLYAWAY_SORTER_SHOW_SORTING'],
                                    "COLLECT_SHORT_SORTER" => "N",
                                    "COLLECT_OUTPUT_OF_SHOW" => $arParams['RSFLYAWAY_SORTER_SHOW_PAGE_COUNT'],
                                    "COLLECT_CNT_TEMPLATES" => $sorterTemplatesCount,
                                    "COLLECT_DEFAULT_TEMPLATE" => $arParams['RSFLYAWAY_SORTER_TEMPLATE_DEFAULT'],
                                    "COLLECT_SORT_BY_NAME" => $arSorts,
                                    "COLLECT_SORT_BY_DEFAULT" => $defaultSort.'_'.$defaultSortType,
                                    "COLLECT_OUTPUT_OF" => $sorterOutputOf,
		                                "COLLECT_OUTPUT_OF_DEFAULT" => $sorterOutputDefault,
                                    "COLLECT_OUTPUT_OF_SHOW_ALL" => isset($arParams['RS_SORTER_OUTPUT_ALL']) ? $arParams['RS_SORTER_OUTPUT_ALL']: 'N',
                ...
                <div class="col col-md-12">
                    <?php
                    $viewMobileVer = "N";
                    if ($collectCTemplate == "showcase_mob") {
                        $viewMobileVer = "Y";
                    }
					...
					<?$intSectionID = $APPLICATION->IncludeComponent(
                        ...
                        array(
                            ...
                            "RSFLYAWAY_TEMPLATE" => $collectCTemplate,
