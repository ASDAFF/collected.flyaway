...
CModule::IncludeModule('collected.quickbuy');

$aTabs = array(
	array('DIV' => 'collected_edit1', 'TAB' => GetMessage('RSQB.TAB1_NAME'), 'ICON' => '', 'TITLE' => GetMessage('RSQB.TAB1_TITLE')),
);
...
{
	COption::SetOptionString('collected.quickbuy', 'init_jquery', $_REQUEST['init_jquery']=='Y' ? 'Y' : 'N' );
}
...
$init_jquery = COption::GetOptionString('collected.quickbuy', 'init_jquery', 'N');
?><tr><?
