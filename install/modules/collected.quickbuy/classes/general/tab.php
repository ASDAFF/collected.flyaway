...
ob_start();
?><input type="hidden" name="collected_quickbuy_id" value="<?=$data['ID']?>" /><?
?><input type="hidden" name="collected_quickbuy_element_id" value="<?=$ELEMENT_ID?>" /><?
?><tr><?
	?><td width="50%" class="adm-detail-content-cell-l"><?=GetMessage('RSQB.ACTIVE')?></td><?
	?><td width="50%" class="adm-detail-content-cell-r"><input type="checkbox" name="collected_quickbuy_active" value="Y"<?if($data['ID']>0):?> checked="checked"<?endif;?> /></td><?
?></tr><?
?><tr><?
	?><td width="50%" class="adm-detail-content-cell-l"><span class="adm-required-field"><?=GetMessage('RSQB.DATE_FROM')?></span></td><?
	?><td width="50%" class="adm-detail-content-cell-r"><?=CAdminCalendar::CalendarDate('collected_quickbuy_date_from', $data['DATE_FROM'], 10, true)?></td><?
?></tr><?
?><tr><?
	?><td width="50%" class="adm-detail-content-cell-l"><span class="adm-required-field"><?=GetMessage('RSQB.DATE_TO')?></span></td><?
	?><td width="50%" class="adm-detail-content-cell-r"><?=CAdminCalendar::CalendarDate('collected_quickbuy_date_to', $data['DATE_TO'], 10, true)?></td><?
?></tr><?
?><tr><?
	?><td width="50%" class="adm-detail-content-cell-l"><span class="adm-required-field"><?=GetMessage('RSQB.DISCOUNT')?></span></td><?
	?><td width="50%" class="adm-detail-content-cell-r"><?
		?><input type="text" name="collected_quickbuy_discount" value="<?=$data['DISCOUNT']?>" /><?
		?><select name="collected_quickbuy_discount_type"><?
...
?><tr><?
	...
	?><td width="50%" class="adm-detail-content-cell-r"><?
		?><select name="collected_quickbuy_currency"><?
...
?><tr><?
	...
	?><td width="50%" class="adm-detail-content-cell-r"><?
		?><input type="text" name="collected_quickbuy_quantity" value="<?=$data['QUANTITY']?>" <?if($bitrix_default_quantity_trace=='N'):?>disabled <?endif;?>/><?
...
?><tr><?
	...
	?><td width="50%" class="adm-detail-content-cell-r"><input type="checkbox" name="collected_quickbuy_auto_renewal" value="Y"<?if($data['AUTO_RENEWAL']=='Y'):?> checked="checked"<?endif;?> /></td><?
?></tr><?
$context = ob_get_contents();
ob_end_clean();

			$form->tabs[] = array(
				'DIV' => 'collected_quickbuy_edit_element',
