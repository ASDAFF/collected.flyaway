...
class Location
{
    ...
    public static function setMyCity($id)
    {
        ...
        if ($arCityData)
		{
            ...
            if (self::$myCity != $arCityData)
			{
				...
				// {
					// foreach (GetModuleEvents('collected.devlibrary', 'OnSiteLocationSelected', true) as $arEvent)
					// {
    ...
    public static function onGeoIpHandlersBuildList() {
        ...
        $arPathIPGeoBaseHandler = [
            '/local/modules/collected.devlibrary/lib/geoip/CollectedIPGeoBaseHandler.php',
            '/bitrix/modules/collected.devlibrary/lib/geoip/CollectedIPGeoBaseHandler.php',
        ];
        ...
        if ($sPathIPGeoBaseHandler) {            
            return new \Bitrix\Main\EventResult(
                ...
                array(
                    '\CollectedIPGeoBaseHandler' => $sPathIPGeoBaseHandler,
                )
            );
        } else {
            return new \Bitrix\Main\EventResult(
