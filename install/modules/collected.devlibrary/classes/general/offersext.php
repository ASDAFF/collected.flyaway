...
class RSDevLibOffersExtension
{
    ...
    public static function GetJSONElement($arElement, $arProps = array(), $arPrices = array(), $params = array())
    {
            ...
            foreach ($arElement['OFFERS'] as $arOffer) {
                if (!isset($arOffersJs[$arOffer['ID']])) {
                    ...
                    if ($params['USE_PRICE_COUNT']) {
                        RSDevLib::getPriceMatrixEx($arOffer, 0, $params['FILTER_PRICE_TYPES'], 'Y', $params['CURRENCY_PARAMS']);
                    ...
                    //RSDevLib::GetDataForProductItem($arOffersJs,$params);
                }
            }
        ...
        if ($params['USE_PRICE_COUNT']) {
            RSDevLib::getPriceMatrixEx($arElement, 0, $params['FILTER_PRICE_TYPES'], 'Y', $params['CURRENCY_PARAMS']);
